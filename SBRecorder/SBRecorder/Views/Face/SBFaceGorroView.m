...
#import "SBFaceGorroView.h"
@interface SBFaceGorroView()
@property (nonatomic,readwrite) UIImageView *faceHeadView;
@end

@implementation SBFaceGorroView
- (UIImageView *)faceHeadView{
    if (_faceHeadView == nil) {
        _faceHeadView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth*2.3, ScreenWidth*2.3)];
        _faceHeadView.image = [UIImage imageNamed:@"针织帽"];
