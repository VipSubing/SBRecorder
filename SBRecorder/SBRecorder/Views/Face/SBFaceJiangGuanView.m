//
//  SBFaceJiangGuanView.m
//  SBRecorder
//
//  Created by qyb on 2018/2/6.
//  Copyright © 2018年 qyb. All rights reserved.
// 将冠

#import "SBFaceJiangGuanView.h"
@interface SBFaceJiangGuanView()
@property (nonatomic,readwrite) UIImageView *faceHeadView;
@end

@implementation SBFaceJiangGuanView
- (UIImageView *)faceHeadView{
    if (_faceHeadView == nil) {
        _faceHeadView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth*1.8, 160)];
        _faceHeadView.image = [UIImage imageNamed:@"将冠"];
...
- (void)drawFaceView:(NSArray *)faces{
    if (faces.count == 1) {
        @autoreleasepool{
            ...
            CGPoint rectCenterPoint = CGPointMake((eyebrowsPoint1.x+eyebrowsPoint3.x)/2, (eyebrowsPoint1.y+eyebrowsPoint3.y)/2-space);
